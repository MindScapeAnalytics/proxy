module github.com/MindScapeAnalytics/proxy
...
require (
	github.com/MindScapeAnalytics/grpc-api/authentication v1.0.19
	github.com/MindScapeAnalytics/grpc-api/core v1.1.10
